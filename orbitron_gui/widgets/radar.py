...
class OrbitronRadar(QtWidgets.QWidget):
...
if __name__ == "__main__":
    orbitron_client = OrbitronTcpClient(HOST="localhost", PORT=5555)
    orbitron_client.create_connection()

    app = QtWidgets.QApplication([])
    tmp = OrbitronRadar(orbitron_client, "Samara", 57173)
    tmp.show()
    app.exec_()
