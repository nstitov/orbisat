...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.orbitron_norad_id_text_label = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        ...
        self.orbitron_norad_ids_scroll_area = QtWidgets.QScrollArea(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.orbitron_norad_ids_scroll_area.sizePolicy().hasHeightForWidth())
        ...
        self.orbitron_norad_ids_scroll_area.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.orbitron_norad_ids_scroll_area.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.orbitron_norad_ids_scroll_area.setWidgetResizable(True)
        self.orbitron_norad_ids_scroll_area.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.orbitron_norad_ids_scroll_area.setObjectName("orbitron_norad_ids_scroll_area")
